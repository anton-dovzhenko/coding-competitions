//------------------------------------
//Task 1
if[5=.aoc.d1.t1"R2, L3"; '"[AssertionException] .aoc.d1.t1 case 1"];
if[2=.aoc.d1.t1"R2, R2, R2"; '"[AssertionException] .aoc.d1.t1 case 2"];
if[12=.aoc.d1.t1"R5, L5, R5, R3"; '"[AssertionException] .aoc.d1.t1 case 3"];
if[4=.aoc.d1.t2"R8, R4, R4, R8"; '"[AssertionException] .aoc.d1.t2 case 1"];
